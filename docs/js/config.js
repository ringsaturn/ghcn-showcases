...
const translations = {
  ...
  monthlyHistoryChart: "月度历史记录",
  historyLoading: "正在加载月度历史...",
  historyNoData: "暂无月度历史数据",
  entries: "记录数",
    compareTitle: "站点对比",
  ...
  monthlyHistoryChart: "Monthly History",
  historyLoading: "Loading monthly history...",
  historyNoData: "Monthly history not available",
  entries: "Entries",
  ...
  monthlyHistoryChart: "月別履歴",
  historyLoading: "月別履歴を読み込み中...",
  historyNoData: "月別履歴データはありません",
  entries: "記録数",
    compareTitle: "観測所の比較",
